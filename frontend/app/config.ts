...
export const BACKEND_URL = "https://zapier-dk3q.onrender.com"
export const HOOKS_URL = "https://zapier-hooks-w0js.onrender.com"
    ...
    <div>
        ...
        {selectedModalIndex && 
                <Modal 
                    ...
                    onSelect={(props: null | { name: string; id: string; metadata: Metadata; }) => {
                        if (props === null) {
...
function Modal(
    { index, onSelect, availableItems } : 
    {   index: number, 
        onSelect: (props: null | { name: string; id: string; metadata: Metadata; }) => void, 
